...
public class ManageTransactionPanel extends JPanel{
    ...
    private void showAddTransactionForm() {
        ...
        // Show the dialog
        int result = JOptionPane.showConfirmDialog(this, formPanel, "Add Transaction", JOptionPane.OK_CANCEL_OPTION);
        if (result == JOptionPane.OK_OPTION) {
            ...
            if (!borrowDateField.getText().matches(dateRegex) || !dueDateField.getText().matches(dateRegex)) {
            ...
            Book book=adminController.getBookById(bookID);
            if(book==null){
                JOptionPane.showMessageDialog(this, "Book with this ID does not exist!", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            try {
                ...
                if (isAdded) {
                    ...
                    JOptionPane.showMessageDialog(this, "Failed to add transaction. It may already exist.", "Error", JOptionPane.ERROR_MESSAGE);
                }
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, "Invalid date format. Please use YYYY-MM-DD.", "Error", JOptionPane.ERROR_MESSAGE);
            }
