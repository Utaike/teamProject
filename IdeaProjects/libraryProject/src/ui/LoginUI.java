...
public class LoginUI extends JFrame {
    ...
    private JPanel CreateLoginForm() {
        ...
        JLabel crateAccText = new JLabel("Don't have an account?");
    ...
    private JPanel CreateRegistrationForm() {
        ...
        JTextField emailField = new JTextField();
        JPasswordField passwordField = new JPasswordField();
        ImageIcon nameIcon = new ImageIcon("IdeaProjects/libraryProject/src/images/icons/profile.png");
        ImageIcon emailIcon = new ImageIcon("ImageIcon emailIcon = new ImageIcon(\"path/to/email_icon.png\");");
        ImageIcon passwordIcon = new ImageIcon("IdeaProjects/libraryProject/src/images/icons/password.png");
